...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (type === "admin") {
    ...
    console.log("register hit for admin");
...
const deleteDev = asyncHandler(async (req, res) => {
  try {
    ...
    if (!id) {
      ...
      const dev = await DevModel.findOne({ devid: id });
      console.log(dev);
      ...
      console.log("dev from delete request ", dev);
      await DevModel.findByIdAndDelete(dev._id);
      console.log(dev._id, "Deleted");
